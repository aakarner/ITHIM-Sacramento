...
For more information about the project background, analysis methods and results, and model source code and data, please refer to [ITHIM-Sacramento GitHub](https://github.com/aakarner/ITHIM-Sacramento)
...
**7. Where can I find the source code, information about the methods used to estimate impacts, the project report, and webinar materials?**

A: All source code and model documentation (including the project report and webinar materials) are available at [ITHIM-Sacramento GitHub](https://github.com/aakarner/ITHIM-Sacramento).

**8.	Who can I contact with other questions?**

A: Please contact the project team at XX.

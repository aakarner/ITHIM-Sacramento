...
Additional documentation, including demonstrations of how the code can be used are included in the [documentation](https://github.com/aakarner/ITHIM-Sacramento/tree/master/02_Documentation) folder.
